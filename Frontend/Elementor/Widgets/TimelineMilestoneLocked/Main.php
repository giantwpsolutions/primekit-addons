<?php
namespace PrimeKit\Frontend\Elementor\Widgets\TimelineMilestoneLocked;
...
class Main extends Widget_Base {
    ...
    public function get_name() {
        ...
        return 'primekitpro-timeline-milestone';
    }

    public function get_title() {
        return esc_html__('Timeline Milestone', 'primekit-addons');
    }

    public function get_icon() {
        // original icon + subtle lock
        return 'eicon-progress-tracker primekit-addons-icon-lock';
    }
    ...
    public function get_keywords() {
        return ['primekit-addons', 'project', 'milestone', 'timeline', 'progress', 'pro', 'locked'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'raw'  => Helpers::get_upsell_html('Timeline Milestone'),
    ...
    protected function render() {
        echo Helpers::get_locked_box_html('Timeline Milestone');
    }
}
