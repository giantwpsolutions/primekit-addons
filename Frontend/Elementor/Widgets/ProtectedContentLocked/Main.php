<?php
namespace PrimeKit\Frontend\Elementor\Widgets\ProtectedContentLocked;
...
class Main extends Widget_Base {
    ...
    public function get_name() {
        ...
        return 'primekitpro-protected-content';
    }

    public function get_title() {
        return esc_html__('Protected Content', 'primekit-addons');
    }

    public function get_icon() {
        // your icon + a lock hint
        return 'eicon-lock primekit-addons-icon eicon-lock';
    }
    ...
    public function get_keywords() {
        return ['primekit-addons', 'primekit', 'protected', 'content', 'lock', 'members', 'pro', 'locked'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'raw'  => Helpers::get_upsell_html('Protected Content'),
    ...
    protected function render() {
        echo Helpers::get_locked_box_html('Protected Content');
    }
}
