<?php
namespace PrimeKit\Frontend\Elementor\Widgets\RevenueGrowthGraphsLocked;
...
class Main extends Widget_Base {
    ...
    public function get_name() {
        ...
        return 'primekitpro-RevenueGrowthGraphs';
    }

    public function get_title() {
        return esc_html__('Revenue Growth Graphs', 'primekit-addons');
    }

    public function get_icon() {
        // original icon + subtle lock
        return 'eicon-product-upsell primekit-addons-icon';
    }
    ...
    public function get_keywords() {
        return ['primekit-addons', 'graph', 'growth', 'revenue', 'charts', 'pro', 'locked'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'raw'  => Helpers::get_upsell_html('Revenue Growth Graphs'),
    ...
    protected function render() {
        echo Helpers::get_locked_box_html('Revenue Growth Graphs');
    }
}