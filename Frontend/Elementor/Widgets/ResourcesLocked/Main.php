<?php
namespace PrimeKit\Frontend\Elementor\Widgets\ResourcesLocked;
...
class Main extends Widget_Base {
    ...
    public function get_name() {
        ...
        return 'primekitpro_resource_widget';
    }

    public function get_title() {
        return esc_html__('Resource', 'primekit-addons');
    }

    public function get_icon() {
        // original icon + subtle lock
        return 'eicon-posts-grid primekit-addons-icon eicon-lock';
    }
    ...
    public function get_keywords() {
        return ['primekit-addons', 'resource', 'downloads', 'grid', 'list', 'pro', 'locked'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'raw'  => Helpers::get_upsell_html('Resources'),
    ...
    protected function render() {
        echo Helpers::get_locked_box_html('Resources');
    }
}
