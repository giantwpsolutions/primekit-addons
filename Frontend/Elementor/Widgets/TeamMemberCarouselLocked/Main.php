<?php
namespace PrimeKit\Frontend\Elementor\Widgets\TeamMemberCarouselLocked;
...
class Main extends Widget_Base {
    ...
    public function get_name() {
        ...
        return 'primekitpro-team-member-carousel';
    }

    public function get_title() {
        return esc_html__('Team Member Carousel', 'primekit-addons');
    }

    public function get_icon() {
        // original icon + subtle lock
        return 'eicon-theme-builder primekit-addons-icon eicon-lock';
    }
    ...
    public function get_keywords() {
        return ['primekit-addons', 'team member', 'carousel', 'slider', 'pro', 'locked'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'raw'  => Helpers::get_upsell_html('Team Member Carousel'),
    ...
    protected function render() {
        echo Helpers::get_locked_box_html('Team Member Carousel');
    }
}