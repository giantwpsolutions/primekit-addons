<?php
namespace PrimeKit\Frontend\Elementor\Widgets\JobsLocked;
...
class Main extends Widget_Base {
    ...
    public function get_name() {
        ...
        return 'primekitpro-jobs';
    }

    public function get_title() {
        return esc_html__('Jobs', 'primekit-addons');
    }

    public function get_icon() {
        // original icon + lock hint
        return 'eicon-folder-o primekit-addons-icon-lock';
    }
    ...
    public function get_keywords() {
        return ['primekit-addons', 'job', 'application', 'apply', 'pro', 'locked'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'raw'  => Helpers::get_upsell_html('Jobs'),
    ...
    protected function render() {
        echo Helpers::get_locked_box_html('Jobs');
    }
}
