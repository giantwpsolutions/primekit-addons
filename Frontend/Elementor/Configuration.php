...
class Configuration
{
    ...
    private function register_pro_locked_widgets($widgets_manager, $namespace_base)
    {
        $pro_widgets = [
            ...
            'primekit_email_signature_locked_widget_field' => 'EmailSignatureLocked\Main',
            'primekit_jobs_locked_widget_field' => 'JobsLocked\Main',
            'primekit_lottie_locked_widget_field' => 'LottieLocked\Main',
            'primekit_project_progress_track_locked_widget_field' => 'ProjectProgressTrackLocked\Main',
            'primekit_protected_content_locked_widget_field' => 'ProtectedContentLocked\Main',
            'primekit_resource_form_locked_widget_field' => 'ResourceFormLocked\Main',
            'primekit_resources_locked_widget_field' => 'ResourcesLocked\Main',
            'primekit_revenue_growth_graphs_locked_widget_field' => 'RevenueGrowthGraphsLocked\Main',
